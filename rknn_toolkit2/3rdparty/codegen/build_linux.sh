...
usage()
{
    echo "Now support rv1103/rv1103b/rv1106/rv1106b/rv1126b/rk3562/rk3566/rk3568/rk3576/rk3588/rk3588s."
...
if [[ -z ${GCC_COMPILER} ]];then
    if [[ ${TARGET_SOC} = "rv1106" || ${TARGET_SOC} = "rv1106b" || ${TARGET_SOC} = "rv1103" || ${TARGET_SOC} = "rv1103b" ]];then
